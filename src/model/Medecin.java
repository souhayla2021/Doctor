...
public class Medecin {
	...
	private Set<Secretaire>Secretaires = new HashSet<Secretaire>();
	public Medecin() {
		super();
		// TODO Auto-generated constructor stub
	}
	public Medecin(String nom, String prenom, String email, Date dateDeNaissance, String adresse, String motDePasse,
			int telephone, String login, Blob image, String cv, Set<model.Rendez_vous> rendez_vous,
			Set<Dossier_Patient> dossier_Patients, Set<Patient> patients, Set<Secretaire> secretaires) {
		super();
		this.nom = nom;
		this.prenom = prenom;
		this.email = email;
